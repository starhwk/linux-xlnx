...
static int xlnx_fb_helper_pan_display(struct fb_var_screeninfo *var,
				      struct fb_info *info)
{
...
static struct fb_ops xlnx_fbdev_ops = {
	...
	.fb_pan_display	= xlnx_fb_helper_pan_display,
...
xlnx_fb_init(struct drm_device *drm, int preferred_bpp, unsigned int num_crtc,
